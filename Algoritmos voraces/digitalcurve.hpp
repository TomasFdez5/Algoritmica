...
class DigitalCurve
{
	...
	public:
		...
		//returns the point in position of the digital curve
		...
		void saveDigitalCurve(char *nombre)const; //guardar la curva en un fichero
												  //guardar la aprx ya que es otra curva digital
