...
class Algorithm
{
	private:
		...
		//posicion de los puntos dominantes, es decir, los puntos de la aproximacion poligonal
		
		//Diginal contour that contains polygonal approximation
		DigitalCurve _polygonalApproximation;
		//Curva digital conformada por los puntos dominantes.

		//Matrix for calculate summations
		//Sirven para acelerar y reducir en uno el orden de complejidad del calculo de los errores.
	...
	public:
		...
		inline void setDominantPointsPosition(const vector <int> & v)
		{
		...
		//This function is used to obtain the polygonal approximation
 		...
 		/*
			MUY IMPORTANTE
			Es el que hay que implementar en metodos que heredan de este.
 		*/
